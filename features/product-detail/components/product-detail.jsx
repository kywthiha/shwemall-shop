import { useProductCarts } from "@/features/products/hooks/use-product-cart";
...
export function ProductDetail({ product }) {
  ...
  return (
    <article className="flex flex-col w-80 group overflow-hidden rounded-md cursor-pointer transition-all duration-300 shadow-md  relative h-full">
